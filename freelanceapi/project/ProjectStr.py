...
from .ProjectMetaData import Area, PbNode
...
class AreaStr(ProjectStr):
    """
    AreaStr A Area Dict is converted back to a str.

    Args:
        ProjectStr (Protocol): Basic representation of Project rows as String
