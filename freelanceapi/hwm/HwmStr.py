...
from .HwmMetaData import BeginIODescription, Hw2Blob
...
class BeginIODescriptionStr(HwmStr):
    """
    BeginIODescriptionStr A BeginIODescription Dict is converted back to a str.

    Args:
        HwmStr (Protocol): Basic representation of Hwm rows as String

    Raises:
        KeyError: The dict was not passed with the desired key.
    """
    meta_data = BeginIODescription()
    _dataset = {}
    _sep = ""
    ...
    def merge_string(self) -> str:
        ...
        print(created_string.string(create_string_from_dict_with_string(sep=self._sep)))
